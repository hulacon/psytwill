...
PROFILE_REGISTRY: dict[str, tuple[list[str], str]] = {
    ...
    "speech_rate": (["speech_rate_*"], "Speaking rate from word timestamps (aud2psy)"),
    ...
    # Continuous depth/spatial-layout arm (normalization-invariant stats).
    "depth": (["depth_*"], "Monocular-depth scene layout (viz2psy)"),
